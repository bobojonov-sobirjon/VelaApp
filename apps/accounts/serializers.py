...
Meditation Name: {ritual.name or 'Custom Meditation'}
Meditation Type: {plan_type.name}
Duration: {ritual.duration or '5'} minutes
Tone: {ritual.tone or 'Dreamy'}
Voice: {ritual.voice or 'Female'}

STATUS: External meditation API is currently unavailable
SERVER: 31.97.98.47:8000
ERROR: Connection timeout

This is a placeholder file. The actual meditation audio would be generated by the external API.
Please check with your system administrator to ensure the meditation generation service is running.
